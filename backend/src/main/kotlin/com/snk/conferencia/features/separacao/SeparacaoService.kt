...
class SeparacaoService(
    ...
    override suspend fun buscarItens(
        ...
        val sql = "SELECT NUSEPARACAO, NUTAREFA, CODPROD, DESCRICAO, MARCA, REFERENCIA, REFFORN, UND, QTD, ENDORIG, ENDDEST, NOMEUSU, SITUACAO, DHINICIALEXEC, DHFINALEXEC FROM APP_ITENS_SEPARACAO WHERE NUSEPARACAO = $nroSeparacao ORDER BY DESCRICAO"
